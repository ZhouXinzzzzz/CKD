...
CFG.EXPERIMENT.NAME = "CKD_r34_r18_bs_256"
...
CFG.SOLVER.LR_COSINE = False
CFG.SOLVER.LR_COSINE_MIN = 0.0
...
CFG.CRD.FEAT.TEACHER_DIM = 64 # resnet56蒸馏20
...
CFG.REVIEWKD.OUT_CHANNELS = [64, 128, 256, 256] #32*4 - 8*4 
...
# CKD CFG 
CFG.CKD = CN()
CFG.CKD.CE_WEIGHT = 1.0
CFG.CKD.CL_WEIGHT = 10.0
CFG.CKD.TEMPERATURE = 1.0
