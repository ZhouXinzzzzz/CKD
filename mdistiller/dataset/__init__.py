...
from .places365 import get_places365_dataloaders, get_places365_dataloaders_sample
...
def get_dataset(cfg):
    if cfg.DATASET.TYPE == "cifar100":
        ...
        if cfg.DISTILLER.TYPE == "CRD":
            train_loader, val_loader, num_data = get_places365_dataloaders_sample(
                batch_size=cfg.SOLVER.BATCH_SIZE,
                val_batch_size=cfg.DATASET.TEST.BATCH_SIZE,
                num_workers=cfg.DATASET.NUM_WORKERS,
                k=cfg.CRD.NCE.K,
            ...
            train_loader, val_loader, num_data = get_places365_dataloaders(
                batch_size=cfg.SOLVER.BATCH_SIZE,
                val_batch_size=cfg.DATASET.TEST.BATCH_SIZE,
                num_workers=cfg.DATASET.NUM_WORKERS,
            )
